...
\begin{tikzpicture}[
    ...
    \node[panel] at (0,0) {};
    \node[anchor=north west,font=\bfseries\ReportDiagramFont] at (-5.95,2.75) {Swagger UI};
...
\begin{tikzpicture}[
    ...
    \node[panel] at (0,0) {};
    \node[anchor=north west,font=\bfseries\ReportDiagramFont] at (-5.95,2.75) {Postman Collection -- AI Vision};
...
\begin{tikzpicture}[
    ...
    \node[panel] at (0,0) {};
    \node[anchor=north west,font=\bfseries\ReportDiagramFont] at (-5.95,2.35) {Docker Compose};
