...
\hline
\textbf{Trịnh Việt Đức} & Nhóm trưởng / Backend Lead & Điều phối nhóm, thiết kế kiến trúc, phát triển `main.py`, `vision.py`, xử lý ảnh, YOLO integration, làm việc với A2/A6/A5, tổng hợp nội dung báo cáo & 40\% \\
\hline
\textbf{Nguyễn Quang Đạt} & API/Contract Owner & Viết `openapi.yaml`, Postman collection, smoke test, tài liệu API, hỗ trợ kiểm thử hợp đồng và minh chứng chạy thử & 30\% \\
\hline
